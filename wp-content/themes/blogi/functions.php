...
if ( ! function_exists( 'blogi_setup' ) ) :
	...
	function blogi_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'blogi_custom_background_args', array(
...
function blogi_scripts() {
	wp_enqueue_style( 'blogi-google-font', blogi_fonts_url(), false );
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/bootstrap/css/bootstrap.min.css' );
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/assets/font-awesome/css/font-awesome.min.css' );
	wp_enqueue_style( 'blogi-style', get_stylesheet_uri(), array( 'bootstrap', 'font-awesome' ) );
